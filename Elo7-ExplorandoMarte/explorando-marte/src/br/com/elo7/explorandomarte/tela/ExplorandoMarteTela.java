...
public class ExplorandoMarteTela extends JFrame {
	...
	public ExplorandoMarteTela() {
		...
		// Executar ação do botão que irá limpar a tela e limpar a quantidade de
		// sondas
	...
	/**
	 * Executar 'método: processarDados - classe: ControleFacade' enviando os
	 * dados informados em tela e tratar a saída retornada do processamento
	 */
	public void executarControleDados() {
		botaoExecutar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					controleFacade.processarDados(areaPlanalto.getText(), areaSonda.getText());

					areaResult.setText(controleFacade.getCoordenadaDestino().toString());
					controleFacade.limparQuantidadeSondas();
					...
					JOptionPane.showMessageDialog(null,
							"Coordenadas incorretas. Informar dados válidos para cada campo! \nExemplo: Planalto: 0 0 / Sondas: 0 0 N");
				} catch (ArrayIndexOutOfBoundsException ex) {
					areaResult.setText(controleFacade.getCoordenadaDestino().toString());
					controleFacade.limparQuantidadeSondas();
					JOptionPane.showMessageDialog(null,
							"Preencher todas as coordenadas separando os dados com espaços! \nExemplo: Planalto: 0 0 / Sondas: 0 0 N");
				}
